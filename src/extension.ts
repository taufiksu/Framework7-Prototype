...
export function activate(context: vscode.ExtensionContext) {
  context.subscriptions.push(
    vscode.commands.registerCommand("f7.BlankPageSingle", () => {
      ...
      terminal.sendText(
        'powershell -command "& { iwr https://gist.github.com/taufiksu/570b2058173bfa6c1546df9094364726/raw/8980d6cbb4bf3737262d2a50a8405ac4a8246d96/home.html -OutFile home.html }"',
        true
      );
      terminal.sendText(
      ...
      // Downloading Index
      terminal.sendText(
        'powershell -command "& { iwr https://gist.github.com/taufiksu/ebef8e3a137e003db3fcb44c92c8254b/raw/afbcab1ef5b01b5c3531995c8e6e5e4119a3dfc0/index.html -OutFile index.html }"',
        true
      );
    })
  );
